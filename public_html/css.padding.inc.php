...
class CSSPadding extends CSSPropertyHandler {
  ...
  function parse($string) {
    ...
    $padding = (new PaddingValue())->init($this->parse_in($string));
...
class CSSPaddingTop extends CSSSubFieldProperty {
  function parse($value) { 
    ...
    return (new PaddingSideValue())->init($value);
  }
...
class CSSPaddingRight extends CSSSubFieldProperty {
  function parse($value) { 
    if ($value === 'inherit') { return CSS_PROPERTY_INHERIT; }
    $result = (new PaddingSideValue())->init($value);
    return $result;
  }
...
$ph = new CSSPadding;
(new CSS())->register_css_property($ph);
(new CSS())->register_css_property(new CSSPaddingLeft($ph,   'left'));
(new CSS())->register_css_property(new CSSPaddingRight($ph,  'right'));
(new CSS())->register_css_property(new CSSPaddingTop($ph,    'top'));
(new CSS())->register_css_property(new CSSPaddingBottom($ph, 'bottom'));
